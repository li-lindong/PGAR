...
FRAMES_NUM={1: 302, 2: 347, 3: 194, 4: 257, 5: 536, 6: 401, 7: 968, 8: 221, 9: 356, 10: 302, 
            ...
            41: 707, 42: 420, 43: 410, 44: 356, 45: 151, 46: 174, 47: 218, 48: 47, 49: 223, 50: 365,
            51: 362, 52: 781, 53: 401, 54: 486, 55: 695, 56: 462, 57: 443, 58: 629, 59: 899, 60: 550,
            61: 373, 62: 200, 63: 433, 64: 319, 65: 443, 66: 315, 67: 391, 68: 945, 69: 1011, 70: 449,
            71: 351, 72: 751}
...
FRAMES_SIZE={1: (480, 720), 2: (480, 720), 3: (480, 720), 4: (480, 720), 5: (480, 720), 6: (480, 720), 7: (480, 720), 8: (480, 720), 9: (480, 720), 10: (480, 720), 
             ...
             41: (480, 720), 42: (480, 720), 43: (480, 720), 44: (480, 720), 45: (480, 720), 46: (480, 720), 47: (480, 720), 48: (480, 720), 49: (480, 720), 50: (480, 720),
             51: (480, 720), 52: (480, 720), 53: (480, 720), 54: (480, 720), 55: (480, 720), 56: (480, 720), 57: (480, 720), 58: (480, 720), 59: (480, 720), 60: (720, 1280),
             61: (720, 1280), 62: (720, 1280), 63: (720, 1280), 64: (720, 1280), 65: (720, 1280), 66: (720, 1280), 67: (720, 1280), 68: (720, 1280), 69: (720, 1280),
             70: (720, 1280), 71: (720, 1280), 72: (720, 1280)}
...
Action6to5 = {0:0, 1:1, 2:2, 3:3, 4:1, 5:4, 6: 5, 7: 6}
Activity5to4 = {0:0, 1:1, 2:2, 3:0, 4:3, 5: 4, 6: 5}
...
class CollectiveDataset(data.Dataset):
    ...
    def load_samples_sequence(self,select_frames):
        ...
        skeletons = []
        init_frame_id = '{}-{}'.format(str(select_frames[0][0]).zfill(3), str(select_frames[0][1]).zfill(4))
        ...
        for i, (sid, src_fid, fid) in enumerate(select_frames):
            ...
            temp_orientations = copy.deepcopy(self.anns[sid][src_fid]['orientation'])
            temp_positions = copy.deepcopy(self.anns[sid][src_fid]['position'])
            temp_skeletons = copy.deepcopy(self.anns[sid][src_fid]['skeleton'])
            bboxes_num.append(len(temp_boxes))
            
            while len(temp_boxes) != self.num_boxes:
                temp_boxes.append((0, 0, 0, 0))
                temp_actions.append(-1)
                temp_orientations.append([-1] * 8)
                temp_positions.append([0, 0])
                temp_skeletons.append([[0, 0]] * 17)
            
            bboxes.append(temp_boxes)
            actions.append(temp_actions)
            orientations.append(temp_orientations)
        ...
        orientations = np.array(orientations, dtype=np.float32).reshape(-1, self.num_boxes, 8)
        positions = np.array(positions, dtype=np.float32).reshape(-1, self.num_boxes, 2)
        skeletons = np.array(skeletons, dtype=np.float32).reshape(-1, self.num_boxes, 17, 2)
        ...
        return images, bboxes, actions, activities, bboxes_num, orientations, positions, skeletons, init_frame_id